<?php
// api/application_bankruptcy/statement/creditor_status_api.php
session_start();
...
class CreditorStatusApi extends BaseStatementApi {
	public function __construct($pdo) {
		parent::__construct($pdo, 'application_bankruptcy_statement_creditor_status', 'id');
	}
}

// API 요청 처리
$api = new CreditorStatusApi($pdo);
