<?php
// api/application_bankruptcy/statement/domestic_court_api.php
session_start();
...
class DomesticCourtApi extends BaseStatementApi {
	public function __construct($pdo) {
		parent::__construct($pdo, 'application_bankruptcy_statement_domestic_court', 'id');
	}
}

// API 요청 처리
$api = new DomesticCourtApi($pdo);
