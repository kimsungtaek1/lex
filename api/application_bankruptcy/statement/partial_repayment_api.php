<?php
// api/application_bankruptcy/statement/partial_repayment_api.php
session_start();
...
class PartialRepaymentApi extends BaseStatementApi {
	public function __construct($pdo) {
		parent::__construct($pdo, 'application_bankruptcy_statement_partial_repayment', 'id');
	}
}

// API 요청 처리
$api = new PartialRepaymentApi($pdo);
