<?php
// api/application_bankruptcy/statement/bankruptcy_reason_api.php
session_start();
...
class BankruptcyReasonApi extends BaseStatementApi {
	public function __construct($pdo) {
		parent::__construct($pdo, 'application_bankruptcy_statement_bankruptcy_reason', 'id');
	}
}

// API 요청 처리
$api = new BankruptcyReasonApi($pdo);
