...
// 문서 정보 설정
$pdf->SetCreator('파산신청 시스템');
$pdf->SetAuthor('파산신청 시스템');
$pdf->SetTitle($basic_info['name'] . ' - 파산 및 면책신청서 자료');
$pdf->SetSubject('파산 및 면책신청서 자료');
$pdf->SetKeywords('파산, 면책, 신청서, 자료');
...
// 출력
$filename = $basic_info['name'] . '_파산및면책신청서_' . date('Ymd') . '.pdf';
