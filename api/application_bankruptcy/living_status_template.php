...
<div class="content-wrapper">
  <div class="left-section">
    ...
    <div class="form">
      ...
      <div class="form-content">
        <div class="checkbox-group">
          <input type="checkbox" id="family_status_1" name="family_status[]" value="① 일반적 이혼의 자녀 부양">
          <label for="family_status_1">① 일반적 이혼의 자녀 부양</label>
        </div>
        <div class="checkbox-group">
          <input type="checkbox" id="family_status_2" name="family_status[]" value="② 시제 보존 가수의 부양">
          <label for="family_status_2">② 시제 보존 가수의 부양</label>
        </div>
        <div class="checkbox-group">
          <input type="checkbox" id="family_status_3" name="family_status[]" value="③ 신청인 소유의 주택">
          <label for="family_status_3">③ 신청인 소유의 주택</label>
        </div>
        <div class="checkbox-group">
          <input type="checkbox" id="family_status_4" name="family_status[]" value="④ 친족 소유 주택에 무상거주">
          <label for="family_status_4">④ 친족 소유 주택에 무상거주</label>
        </div>
        <div class="checkbox-group">
          <input type="checkbox" id="family_status_5" name="family_status[]" value="⑤ 월세 및 소유 주택 무상거주">
          <label for="family_status_5">⑤ 월세 및 소유 주택 무상거주</label>
        </div>
        <div class="checkbox-group">
          <input type="checkbox" id="family_status_6" name="family_status[]" value="⑥ 기타">
