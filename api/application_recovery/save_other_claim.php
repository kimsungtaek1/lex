...
$creditor_principal = isset($_POST['creditor_principal']) ? (int)$_POST['creditor_principal'] : 0;
$creditor_interest = isset($_POST['creditor_interest']) ? (int)$_POST['creditor_interest'] : 0;
$undisputed_principal = isset($_POST['undisputed_principal']) ? (int)$_POST['undisputed_principal'] : 0;
$undisputed_interest = isset($_POST['undisputed_interest']) ? (int)$_POST['undisputed_interest'] : 0;
