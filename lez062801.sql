...
CREATE TABLE application_recovery_creditor_guaranteed_debts (
  ...
  phone varchar(20) DEFAULT NULL COMMENT '전화번호',
  fax varchar(20) DEFAULT NULL COMMENT '팩스번호',
  claim_reason varchar(255) DEFAULT NULL COMMENT '채권원인',
  original_debt_balance decimal(15,2) DEFAULT 0.00,
  original_debt_description text DEFAULT NULL,
  principal int(11) DEFAULT 0 COMMENT '원금',
  principal_calculation text DEFAULT NULL COMMENT '원금 산정근거',
  interest int(11) DEFAULT 0 COMMENT '이자',
  interest_calculation text DEFAULT NULL COMMENT '이자 산정근거',
  default_rate decimal(5,2) DEFAULT NULL,
  claim_content text DEFAULT NULL COMMENT '채권내용',
  future_right_type enum('포기','청구') DEFAULT NULL COMMENT '장래구상권',
  created_at datetime DEFAULT current_timestamp(),
  updated_at datetime DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE application_recovery_creditor_undetermined_claims (
  ...
  trust_property_details varchar(5) DEFAULT NULL,
